...
public class FriendStorage {
    ...
    public void addFriend(Long userId, Long friendId) {
        /*при создании пользователей проверка на их существование уже будет проходить, поэтому нет смысла проверять
        это дополнительно здесь, так что проверку я попросту убрал :)*/
